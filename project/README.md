...
This is an analysis project of a superstore, where we cleaned the data, manipulated the data and then visualized the data.
For this we used python libraries - Pandas, Numpy, Matplotlib, seaborn etc.
